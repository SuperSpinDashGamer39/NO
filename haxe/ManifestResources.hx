...
@:keep @:dox(hide) class ManifestResources {
	...
	public static function init (config:Dynamic):Void {
		...
		Assets.libraryPaths["bonusWeek"] = rootPath + "manifest/bonusWeek.json";
		...
		library = Assets.getLibrary ("bonusWeek");
		if (library != null) preloadLibraries.push (library);
		else preloadLibraryNames.push ("bonusWeek");
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_ballistic_pleasesubscribe_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_ballistic_simfile_background_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_ballistic_simfile_banner_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_ballistic_simfile_information_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_ballistic_simfile_lincoln_loud_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_ballistic_simfile_lincoln_loud_sm extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_lo_fight_pleasesubscribe_txt extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_overhead_pleasesubscribe_txt extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_ballistic_notes_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_ballistic_notes_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_bomb_notes_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_bomb_notes_xml extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_icongrid_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_whittydancetitle_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_whittydancetitle_xml extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_ballisticbackground_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_ballisticbackground_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_boyfriendport_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_boyfriendport_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_cuttindeezeballs_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_cuttindeezeballs_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_gf_standing_sway_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_gf_standing_sway_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_gf_standing_zoooooooooooooom_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_gf_standing_zoooooooooooooom_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_thefunnyeffect_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_whittyback_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_whittycrazy_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_whittycrazy_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_whittycutscene_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_whittycutscene_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_whittyfront_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_whittyport_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_whittyport_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_whittysprites_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_bonusweek_images_whittysprites_xml extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__manifest_bonusweek_json extends null { }
