...
HX_DECLARE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_292_new)
...
{
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_292_new)
HXLINE( 296)		( ( ::SongMetadata)(__this) )->songCharacter = HX_("",00,00,00,00);
HXLINE( 295)		( ( ::SongMetadata)(__this) )->week = 0;
HXLINE( 294)		( ( ::SongMetadata)(__this) )->songName = HX_("",00,00,00,00);
HXLINE( 300)		( ( ::SongMetadata)(__this) )->songName = song;
HXLINE( 301)		( ( ::SongMetadata)(__this) )->week = week;
HXLINE( 302)		( ( ::SongMetadata)(__this) )->songCharacter = songCharacter;
            	}
