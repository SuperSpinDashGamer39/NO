...
class HXCPP_CLASS_ATTRIBUTES PlayState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		bool inCutscene;
		 ::flixel::FlxSprite wBg;
		 ::flixel::FlxSprite nwBg;
		 ::flixel::FlxSprite wstageFront;
		...
		void turnToCrazyWhitty();
		::Dynamic turnToCrazyWhitty_dyn();

		void whittyAnimation( ::DialogueBox dialogueBox,bool bside);
		::Dynamic whittyAnimation_dyn();
