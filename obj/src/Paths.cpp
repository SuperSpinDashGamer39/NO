...
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_19_getPath,"Paths","getPath",0x5f104ffb,"Paths.getPath","Paths.hx",19,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_37_getLibraryPath,"Paths","getLibraryPath",0xe56efeaa,"Paths.getLibraryPath","Paths.hx",37,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_42_getLibraryPathForce,"Paths","getLibraryPathForce",0xe1e5bae1,"Paths.getLibraryPathForce","Paths.hx",42,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_47_getPreloadPath,"Paths","getPreloadPath",0x2fdd9e78,"Paths.getPreloadPath","Paths.hx",47,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_51_file,"Paths","file",0x8f872fdc,"Paths.file","Paths.hx",51,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_56_lua,"Paths","lua",0x5a344458,"Paths.lua","Paths.hx",56,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_61_luaImage,"Paths","luaImage",0xedd38be3,"Paths.luaImage","Paths.hx",61,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_66_txt,"Paths","txt",0x5a3a5910,"Paths.txt","Paths.hx",66,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_70_xml,"Paths","xml",0x5a3d5877,"Paths.xml","Paths.hx",70,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_74_json,"Paths","json",0x9233a388,"Paths.json","Paths.hx",74,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_79_sound,"Paths","sound",0x86f65f6f,"Paths.sound","Paths.hx",79,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_84_soundRandom,"Paths","soundRandom",0x8e79b2d2,"Paths.soundRandom","Paths.hx",84,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_88_music,"Paths","music",0x1684a345,"Paths.music","Paths.hx",88,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_92_voices,"Paths","voices",0xbbb84fe1,"Paths.voices","Paths.hx",92,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_96_inst,"Paths","inst",0x9186a526,"Paths.inst","Paths.hx",96,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_100_image,"Paths","image",0xc392f1fb,"Paths.image","Paths.hx",100,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_104_font,"Paths","font",0x8f8bbf2f,"Paths.font","Paths.hx",104,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_108_getSparrowAtlas,"Paths","getSparrowAtlas",0x5a1f05f5,"Paths.getSparrowAtlas","Paths.hx",108,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_112_getPackerAtlas,"Paths","getPackerAtlas",0xa8de8c4f,"Paths.getPackerAtlas","Paths.hx",112,0x309ea470)
...
::String Paths_obj::getPath(::String file,::String type,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_19_getPath)
HXLINE(  20)		if (::hx::IsNotNull( library )) {
HXLINE(  21)			return ::Paths_obj::getLibraryPath(file,library);
            		}
HXLINE(  22)		if (::hx::IsNotNull( ::Paths_obj::currentLevel )) {
HXLINE(  24)			::String library = ::Paths_obj::currentLevel;
HXDLIN(  24)			::String levelPath = (((((HX_("",00,00,00,00) + library) + HX_(":assets/",52,05,4a,2c)) + library) + HX_("/",2f,00,00,00)) + file);
HXLINE(  25)			if (::openfl::utils::Assets_obj::exists(levelPath,type)) {
HXLINE(  26)				return levelPath;
            			}
HXLINE(  27)			levelPath = ((((HX_("shared",a5,5e,2b,1d) + HX_(":assets/",52,05,4a,2c)) + HX_("shared",a5,5e,2b,1d)) + HX_("/",2f,00,00,00)) + file);
HXLINE(  28)			if (::openfl::utils::Assets_obj::exists(levelPath,type)) {
HXLINE(  29)				return levelPath;
            			}
            		}
HXLINE(  32)		return (HX_("assets/",4c,2a,dc,36) + file);
            	}
...
::String Paths_obj::getLibraryPath(::String file,::String __o_library){
            	...
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_37_getLibraryPath)
HXDLIN(  37)		bool _hx_tmp;
HXDLIN(  37)		if ((library != HX_("preload",c9,47,43,35))) {
HXDLIN(  37)			_hx_tmp = (library == HX_("default",c1,d8,c3,9b));
            		}
            		else {
HXDLIN(  37)			_hx_tmp = true;
            		}
HXDLIN(  37)		if (_hx_tmp) {
HXDLIN(  37)			return (HX_("assets/",4c,2a,dc,36) + file);
            		}
            		else {
HXDLIN(  37)			return (((((HX_("",00,00,00,00) + library) + HX_(":assets/",52,05,4a,2c)) + library) + HX_("/",2f,00,00,00)) + file);
            		}
...
::String Paths_obj::getLibraryPathForce(::String file,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_42_getLibraryPathForce)
HXDLIN(  42)		return (((((HX_("",00,00,00,00) + library) + HX_(":assets/",52,05,4a,2c)) + library) + HX_("/",2f,00,00,00)) + file);
            	}
...
::String Paths_obj::getPreloadPath(::String file){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_47_getPreloadPath)
HXDLIN(  47)		return (HX_("assets/",4c,2a,dc,36) + file);
            	}
...
::String Paths_obj::file(::String file,::String __o_type,::String library){
            	...
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_51_file)
HXDLIN(  51)		return ::Paths_obj::getPath(file,type,library);
            	}
...
::String Paths_obj::lua(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_56_lua)
HXDLIN(  56)		return ::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + key) + HX_(".lua",4a,2a,ba,1e)),HX_("TEXT",ad,94,ba,37),library);
            	}
...
::String Paths_obj::luaImage(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_61_luaImage)
HXDLIN(  61)		return ::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            	}
...
::String Paths_obj::txt(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_66_txt)
HXDLIN(  66)		return ::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + key) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library);
            	}
...
::String Paths_obj::xml(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_70_xml)
HXDLIN(  70)		return ::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            	}
...
::String Paths_obj::json(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_74_json)
HXDLIN(  74)		return ::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + key) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library);
            	}
...
::String Paths_obj::sound(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_79_sound)
HXDLIN(  79)		return ::Paths_obj::getPath((((HX_("sounds/",eb,02,a5,b6) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("SOUND",af,c4,ba,fe),library);
            	}
...
::String Paths_obj::soundRandom(::String key,int min,int max,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_84_soundRandom)
HXDLIN(  84)		return ::Paths_obj::sound((key + ::flixel::FlxG_obj::random->_hx_int(min,max,null())),library);
            	}
...
::String Paths_obj::music(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_88_music)
HXDLIN(  88)		return ::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library);
            	}
...
::String Paths_obj::voices(::String song){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_92_voices)
HXDLIN(  92)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + song.toLowerCase()) + HX_("/Voices.",1e,f6,e5,90)) + HX_("ogg",4f,94,54,00));
            	}
...
::String Paths_obj::inst(::String song){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_96_inst)
HXDLIN(  96)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + song.toLowerCase()) + HX_("/Inst.",f9,6e,13,1c)) + HX_("ogg",4f,94,54,00));
            	}
...
::String Paths_obj::font(::String key){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_104_font)
HXDLIN( 104)		return (HX_("assets/fonts/",37,ff,a5,9c) + key);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Paths_obj,font,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames Paths_obj::getSparrowAtlas(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_108_getSparrowAtlas)
HXDLIN( 108)		::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 108)		return ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Paths_obj,getSparrowAtlas,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames Paths_obj::getPackerAtlas(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_112_getPackerAtlas)
HXDLIN( 112)		::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 112)		return ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSpriteSheetPacker(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
            	}
