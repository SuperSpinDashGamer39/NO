...
HX_DEFINE_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_263_new,"MultiCallback","new",0x3682e930,"MultiCallback.new","LoadingState.hx",263,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_287_add,"MultiCallback","add",0x36790af1,"MultiCallback.add","LoadingState.hx",287,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_280_add,"MultiCallback","add",0x36790af1,"MultiCallback.add","LoadingState.hx",280,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_312_log,"MultiCallback","log",0x36816d54,"MultiCallback.log","LoadingState.hx",312,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_316_getFired,"MultiCallback","getFired",0x1ac970a8,"MultiCallback.getFired","LoadingState.hx",316,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_317_getUnfired,"MultiCallback","getUnfired",0xfdf08a2f,"MultiCallback.getUnfired","LoadingState.hx",317,0x53ff9bc9)

void MultiCallback_obj::__construct( ::Dynamic callback,::String logId){
            	HX_GC_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_263_new)
HXLINE( 271)		this->fired = ::Array_obj< ::String >::__new();
HXLINE( 270)		this->unfired =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 268)		this->numRemaining = 0;
HXLINE( 267)		this->length = 0;
HXLINE( 266)		this->logId = null();
HXLINE( 275)		this->callback = callback;
HXLINE( 276)		this->logId = logId;
            	}
...
bool MultiCallback_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic MultiCallback_obj::add(::String __o_id){
            		...
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_287_add)
HXLINE( 287)			if (_gthis->unfired->exists(id)) {
HXLINE( 289)				_gthis->unfired->remove(id);
HXLINE( 290)				_gthis->fired->push(id);
HXLINE( 291)				_gthis->numRemaining--;
HXLINE( 293)				if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 294)					if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 294)						::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + ((((HX_("fired ",72,04,21,89) + id) + HX_(", ",74,26,00,00)) + _gthis->numRemaining) + HX_(" remaining",d6,c2,10,c5))),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),313,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            					}
            				}
HXLINE( 296)				if ((_gthis->numRemaining == 0)) {
HXLINE( 298)					if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 299)						if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 299)							::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + HX_("all callbacks fired",5d,d8,ec,82)),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),313,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            						}
            					}
HXLINE( 300)					_gthis->callback();
            				}
            			}
            			else {
HXLINE( 304)				if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 304)					::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + (HX_("already fired ",fa,e7,0c,57) + id)),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),313,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            				}
            			}
            		}
            	...
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_280_add)
HXLINE( 279)		 ::MultiCallback _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 281)		id = (((HX_("",00,00,00,00) + this->length) + HX_(":",3a,00,00,00)) + id);
HXLINE( 282)		this->length++;
HXLINE( 283)		this->numRemaining++;
HXLINE( 284)		 ::Dynamic func = null();
HXLINE( 285)		func =  ::Dynamic(new _hx_Closure_0(id,_gthis));
HXLINE( 306)		this->unfired->set(id,func);
HXLINE( 307)		return func;
            	}
...
void MultiCallback_obj::log(::String msg){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_312_log)
HXDLIN( 312)		if (::hx::IsNotNull( this->logId )) {
HXLINE( 313)			::haxe::Log_obj::trace((((HX_("",00,00,00,00) + this->logId) + HX_(": ",a6,32,00,00)) + msg),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),313,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            		}
            	}
...
::Array< ::String > MultiCallback_obj::getFired(){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_316_getFired)
HXDLIN( 316)		return this->fired->copy();
            	}
...
::Array< ::String > MultiCallback_obj::getUnfired(){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_317_getUnfired)
HXDLIN( 317)		::Array< ::String > _g = ::Array_obj< ::String >::__new(0);
HXDLIN( 317)		{
HXDLIN( 317)			 ::Dynamic id = this->unfired->keys();
HXDLIN( 317)			while(( (bool)(id->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 317)				::String id1 = ( (::String)(id->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXDLIN( 317)				_g->push(id1);
            			}
            		}
HXDLIN( 317)		return _g;
            	}
