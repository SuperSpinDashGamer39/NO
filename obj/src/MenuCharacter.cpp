...
HX_LOCAL_STACK_FRAME(_hx_pos_ab0efa272e315d84_64_setCharacter,"MenuCharacter","setCharacter",0x186f24ab,"MenuCharacter.setCharacter","MenuCharacter.hx",64,0x28a93714)
...
HXLINE(  50)		this->animation->addByPrefix(HX_("gf-whitty",6f,ae,64,b4),HX_("GF Dancing Beat WHITE",f0,84,9e,e1),24,null(),null(),null());
HXLINE(  51)		this->animation->addByPrefix(HX_("dad",47,36,4c,00),HX_("Dad idle dance BLACK LINE",b5,ef,e0,8b),24,null(),null(),null());
HXLINE(  52)		this->animation->addByPrefix(HX_("spooky",eb,bd,9e,c1),HX_("spooky dance idle BLACK LINES",b4,84,b1,60),24,null(),null(),null());
HXLINE(  53)		this->animation->addByPrefix(HX_("pico",e5,e8,57,4a),HX_("Pico Idle Dance",62,48,dd,f6),24,null(),null(),null());
HXLINE(  54)		this->animation->addByPrefix(HX_("mom",cb,16,53,00),HX_("Mom Idle BLACK LINES",c7,f6,14,d1),24,null(),null(),null());
HXLINE(  55)		this->animation->addByPrefix(HX_("parents-christmas",fe,94,c5,32),HX_("Parent Christmas Idle",c8,04,64,10),24,null(),null(),null());
HXLINE(  56)		this->animation->addByPrefix(HX_("senpai",3c,df,8d,6b),HX_("SENPAI idle Black Lines",f6,9a,63,5d),24,null(),null(),null());
HXLINE(  57)		this->animation->addByPrefix(HX_("whitty",c1,16,e4,bb),HX_("Whitty idle dance BLACK LINE",ef,67,60,e6),24,null(),null(),null());
HXLINE(  59)		this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * scale)),null());
...
void MenuCharacter_obj::setCharacter(::String character){
            	HX_STACKFRAME(&_hx_pos_ab0efa272e315d84_64_setCharacter)
HXLINE(  65)		if ((character == HX_("",00,00,00,00))) {
HXLINE(  67)			this->set_visible(false);
HXLINE(  68)			return;
            		}
            		else {
HXLINE(  72)			this->set_visible(true);
            		}
HXLINE(  75)		this->animation->play(character,null(),null(),null());
HXLINE(  77)		 ::CharacterSetting setting = ( ( ::CharacterSetting)(::MenuCharacter_obj::settings->get(character)) );
HXLINE(  78)		this->offset->set(setting->x,setting->y);
HXLINE(  79)		Float _hx_tmp = this->get_width();
HXDLIN(  79)		this->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * setting->scale)),null());
HXLINE(  80)		this->set_flipX((setting->flipped != this->flipped));
            	}
...
HXDLIN(  24)			_g->set(HX_("whitty",c1,16,e4,bb), ::CharacterSetting_obj::__alloc( HX_CTX ,-15,130,null(),true));
HXDLIN(  24)			return _g;
            		}
