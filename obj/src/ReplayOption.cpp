...
HX_DEFINE_STACK_FRAME(_hx_pos_1637001de69262c2_457_new,"ReplayOption","new",0x7094b10e,"ReplayOption.new","Options.hx",457,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1637001de69262c2_463_press,"ReplayOption","press",0x73453bb1,"ReplayOption.press","Options.hx",463,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1637001de69262c2_471_updateDisplay,"ReplayOption","updateDisplay",0xfbfe5567,"ReplayOption.updateDisplay","Options.hx",471,0x9d9a0240)

void ReplayOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_1637001de69262c2_457_new)
HXLINE( 458)		super::__construct();
HXLINE( 459)		this->description = desc;
            	}
...
bool ReplayOption_obj::press(){
            	HX_GC_STACKFRAME(&_hx_pos_1637001de69262c2_463_press)
HXLINE( 464)		::haxe::Log_obj::trace(HX_("switch",f4,49,79,c5),::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),464,HX_("ReplayOption",1c,d2,4f,b9),HX_("press",83,53,88,c8)));
HXLINE( 465)		{
HXLINE( 465)			 ::flixel::FlxState nextState =  ::LoadReplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 465)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 465)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
...
::String ReplayOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_1637001de69262c2_471_updateDisplay)
HXDLIN( 471)		return HX_("Load replays",92,1b,40,79);
            	}
