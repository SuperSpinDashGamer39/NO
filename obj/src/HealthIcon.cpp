...
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_57_update,"HealthIcon","update",0x767ac302,"HealthIcon.update","HealthIcon.hx",57,0xf7836789)
...
HXLINE(  16)		this->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("iconGrid",df,9a,73,71)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d)),true,150,150,null(),null());
...
HXLINE(  40)		this->animation->add(HX_("whitty",c1,16,e4,bb),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_23,2),0,false,isPlayer,null());
HXLINE(  41)		this->animation->add(HX_("whittyBSide",98,d0,0b,e6),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_24,2),0,false,isPlayer,null());
HXLINE(  42)		this->animation->add(HX_("whittyBSideCrazy",59,3e,de,32),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_25,2),0,false,isPlayer,null());
HXLINE(  43)		this->animation->add(HX_("whittyCrazy",90,03,ea,8d),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_26,2),0,false,isPlayer,null());
HXLINE(  44)		this->animation->add(HX_("wide",13,68,f8,4e),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_27,2),0,false,isPlayer,null());
HXLINE(  45)		this->animation->play(_hx_char,null(),null(),null());
HXLINE(  47)		::String _hx_switch_0 = _hx_char;
...
void HealthIcon_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_57_update)
HXLINE(  58)		this->super::update(elapsed);
HXLINE(  60)		if (::hx::IsNotNull( this->sprTracker )) {
HXLINE(  61)			Float _hx_tmp = this->sprTracker->x;
HXDLIN(  61)			Float _hx_tmp1 = ((_hx_tmp + this->sprTracker->get_width()) + 10);
HXDLIN(  61)			this->setPosition(_hx_tmp1,(this->sprTracker->y - ( (Float)(30) )));
            		}
            	}
