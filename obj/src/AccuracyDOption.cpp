...
HX_DEFINE_STACK_FRAME(_hx_pos_3fccbae956d84d25_478_new,"AccuracyDOption","new",0xe62cee92,"AccuracyDOption.new","Options.hx",478,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_3fccbae956d84d25_484_press,"AccuracyDOption","press",0xad8ae235,"AccuracyDOption.press","Options.hx",484,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_3fccbae956d84d25_492_updateDisplay,"AccuracyDOption","updateDisplay",0xd1d41feb,"AccuracyDOption.updateDisplay","Options.hx",492,0x9d9a0240)

void AccuracyDOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_3fccbae956d84d25_478_new)
HXLINE( 479)		super::__construct();
HXLINE( 480)		this->description = desc;
            	}
...
bool AccuracyDOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_3fccbae956d84d25_484_press)
HXLINE( 485)		 ::Dynamic _hx_tmp;
HXDLIN( 485)		if (::hx::IsEq( ::flixel::FlxG_obj::save->data->__Field(HX_("accuracyMod",09,b2,8a,86),::hx::paccDynamic),1 )) {
HXLINE( 485)			_hx_tmp = 0;
            		}
            		else {
HXLINE( 485)			_hx_tmp = 1;
            		}
HXDLIN( 485)		::flixel::FlxG_obj::save->data->__SetField(HX_("accuracyMod",09,b2,8a,86),_hx_tmp,::hx::paccDynamic);
HXLINE( 486)		this->display = this->updateDisplay();
HXLINE( 487)		return true;
            	}


::String AccuracyDOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_3fccbae956d84d25_492_updateDisplay)
HXDLIN( 492)		::String _hx_tmp;
HXDLIN( 492)		if (::hx::IsEq( ::flixel::FlxG_obj::save->data->__Field(HX_("accuracyMod",09,b2,8a,86),::hx::paccDynamic),0 )) {
HXDLIN( 492)			_hx_tmp = HX_("Accurate",14,d1,76,d9);
            		}
            		else {
HXDLIN( 492)			_hx_tmp = HX_("Complex",10,8e,c2,50);
            		}
HXDLIN( 492)		return (HX_("Accuracy Mode: ",d0,5b,59,26) + _hx_tmp);
            	}
