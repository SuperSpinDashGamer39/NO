...
HXLINE(  79)							ranking = (ranking + HX_(" C",23,1c,00,00));
            						...
            						break;
            						case (int)15: {
HXLINE(  81)							ranking = (ranking + HX_(" Your dog shit",b1,b7,fe,43));
            						}
            						break;
            					}
...
HXDLIN( 135)			_hx_tmp = ((HX_("NPS: ",b7,7e,61,1e) + nps) + _hx_tmp1);
            		}
            		else {
...
HXDLIN( 136)			::String _hx_tmp2 = ((((HX_("Score:",c8,e8,ff,79) + _hx_tmp) + HX_(" | Misses:",ac,fe,5e,5d)) + ::PlayState_obj::misses) + HX_(" | Accuracy:",fd,ee,6b,1b));
