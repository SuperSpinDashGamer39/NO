...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_81_create,"LoadingState","create",0x65cff835,"LoadingState.create","LoadingState.hx",81,0x53ff9bc9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_88_checkLoadSong,"LoadingState","checkLoadSong",0xc27149ea,"LoadingState.checkLoadSong","LoadingState.hx",88,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_97_checkLoadSong,"LoadingState","checkLoadSong",0xc27149ea,"LoadingState.checkLoadSong","LoadingState.hx",97,0x53ff9bc9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_111_checkLibrary,"LoadingState","checkLibrary",0xd141a10c,"LoadingState.checkLibrary","LoadingState.hx",111,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_116_beatHit,"LoadingState","beatHit",0x12c36b24,"LoadingState.beatHit","LoadingState.hx",116,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_130_update,"LoadingState","update",0x70c61742,"LoadingState.update","LoadingState.hx",130,0x53ff9bc9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_190_destroy,"LoadingState","destroy",0xc344ada1,"LoadingState.destroy","LoadingState.hx",190,0x53ff9bc9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_234_initSongsManifest,"LoadingState","initSongsManifest",0xe6a6ff04,"LoadingState.initSongsManifest","LoadingState.hx",234,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_256_initSongsManifest,"LoadingState","initSongsManifest",0xe6a6ff04,"LoadingState.initSongsManifest","LoadingState.hx",256,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_197_initSongsManifest,"LoadingState","initSongsManifest",0xe6a6ff04,"LoadingState.initSongsManifest","LoadingState.hx",197,0x53ff9bc9)
...
void LoadingState_obj::create(){
            		...
            		void _hx_run( ::lime::utils::AssetLibrary lib){
            			...
            			void _hx_run( ::flixel::util::FlxTimer _){
            				HX_GC_STACKFRAME(&_hx_pos_7b9d652bf7289928_81_create)
HXLINE(  81)				introComplete();
            			}
...
HXLINE(  68)				if ((::PlayState_obj::storyWeek == 7)) {
HXLINE(  70)					_gthis->checkLibrary(HX_("bonusWeek",33,2e,27,a4));
HXLINE(  71)					::haxe::Log_obj::trace(HX_("loading whitty",e5,27,25,14),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),71,HX_("LoadingState",15,62,ae,41),HX_("create",fc,66,0f,7c)));
            				}
            				else {
HXLINE(  74)					_gthis->checkLibrary((HX_("week",f4,5f,f5,4e) + ::PlayState_obj::storyWeek));
            				}
            			}
            			else {
HXLINE(  77)				_gthis->checkLibrary(HX_("tutorial",9e,8f,b5,82));
            			}
HXLINE(  79)			Float fadeTime = ((Float)0.5);
HXLINE(  80)			::flixel::FlxG_obj::camera->fade(::flixel::FlxG_obj::camera->bgColor,fadeTime,true,null(),null());
HXLINE(  81)			 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start((fadeTime + ((Float)1.0)), ::Dynamic(new _hx_Closure_0(introComplete)),null());
            		}
            		HX_END_LOCAL_FUNC1((void))
...
void LoadingState_obj::checkLoadSong(::String path){
            	HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_88_checkLoadSong)
HXDLIN(  88)		if (!(::openfl::utils::IAssetCache_obj::hasSound(::openfl::utils::Assets_obj::cache,path))) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::Dynamic,callback) HXARGC(1)
            			void _hx_run( ::openfl::media::Sound _){
            				HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_97_checkLoadSong)
HXLINE(  97)				callback();
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE(  90)			 ::lime::utils::AssetLibrary library = ::openfl::utils::Assets_obj::getLibrary(HX_("songs",fe,36,c7,80));
HXLINE(  91)			::String symbolPath = ( (::String)(path.split(HX_(":",3a,00,00,00))->pop()) );
HXLINE(  96)			 ::Dynamic callback = this->callbacks->add((HX_("song:",c5,36,c7,80) + path));
HXLINE(  97)			::openfl::utils::Assets_obj::loadSound(path,null())->onComplete( ::Dynamic(new _hx_Closure_0(callback)));
            		}
            	}
...
HXDLIN( 103)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),103,HX_("LoadingState",15,62,ae,41),HX_("checkLibrary",13,df,f6,2c)));
HXLINE( 104)		if (::hx::IsNull( ::openfl::utils::Assets_obj::getLibrary(library) )) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::Dynamic,callback) HXARGC(1)
            			void _hx_run( ::openfl::utils::AssetLibrary _){
            				HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_111_checkLibrary)
HXLINE( 111)				callback();
            			}
            			HX_END_LOCAL_FUNC1((void))
...
void LoadingState_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_116_beatHit)
HXLINE( 117)		this->super::beatHit();
HXLINE( 119)		this->logo->animation->play(HX_("bump",f6,0f,20,41),null(),null(),null());
HXLINE( 120)		this->danceLeft = !(this->danceLeft);
HXLINE( 122)		if (this->danceLeft) {
HXLINE( 123)			this->gfDance->animation->play(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            		}
            		else {
HXLINE( 125)			this->gfDance->animation->play(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            		}
            	}


void LoadingState_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_130_update)
HXDLIN( 130)		this->super::update(elapsed);
            	}
...
HXLINE( 142)		{
HXLINE( 142)			 ::flixel::FlxState nextState = this->target;
...
void LoadingState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_190_destroy)
HXLINE( 191)		this->super::destroy();
HXLINE( 193)		this->callbacks = null();
            	}
...
::String LoadingState_obj::getSongPath(){
            	HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_147_getSongPath)
HXDLIN( 147)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + ( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase()) + HX_("/Inst.",f9,6e,13,1c)) + HX_("ogg",4f,94,54,00));
            	}
...
::String LoadingState_obj::getVocalPath(){
            	HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_152_getVocalPath)
HXDLIN( 152)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + ( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase()) + HX_("/Voices.",1e,f6,e5,90)) + HX_("ogg",4f,94,54,00));
            	}
...
HXDLIN( 157)		 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(target,stopMusic);
HXDLIN( 157)		if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXDLIN( 157)			::flixel::FlxG_obj::game->_requestedState = nextState;
            		}
            	}
...
HXLINE( 162)		::Paths_obj::setCurrentLevel((HX_("week",f4,5f,f5,4e) + ::PlayState_obj::storyWeek));
HXLINE( 171)		bool _hx_tmp;
HXDLIN( 171)		if (stopMusic) {
HXLINE( 171)			_hx_tmp = ::hx::IsNotNull( ::flixel::FlxG_obj::sound->music );
            		}
            		else {
HXLINE( 171)			_hx_tmp = false;
            		}
HXDLIN( 171)		if (_hx_tmp) {
HXLINE( 172)			 ::flixel::_hx_system::FlxSound _this = ::flixel::FlxG_obj::sound->music;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(LoadingState_obj,getNextState,return )
 ...
 ::lime::app::Future LoadingState_obj::initSongsManifest(){
            		...
            		void _hx_run( ::lime::utils::AssetManifest manifest){
            			HX_GC_STACKFRAME(&_hx_pos_7b9d652bf7289928_234_initSongsManifest)
HXLINE( 235)			if (::hx::IsNull( manifest )) {
HXLINE( 237)				promise->error(((HX_("Cannot parse asset manifest for library \"",cf,1e,cc,48) + id) + HX_("\"",22,00,00,00)));
HXLINE( 238)				return;
            			}
HXLINE( 241)			 ::lime::utils::AssetLibrary library = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
HXLINE( 243)			if (::hx::IsNull( library )) {
HXLINE( 245)				promise->error(((HX_("Cannot open library \"",44,cc,55,e7) + id) + HX_("\"",22,00,00,00)));
            			}
            			else {
HXLINE( 250)				::lime::utils::Assets_obj::libraries->set(id,library);
HXLINE( 251)				library->onChange->add(::lime::utils::Assets_obj::onChange->dispatch_dyn(),null(),null());
HXLINE( 252)				 ::lime::app::Promise_lime_utils_AssetLibrary promise1 = promise;
HXDLIN( 252)				promise1->completeWith(::lime::app::Future_obj::withValue(library));
            			}
            		}
            		HX_END_LOCAL_FUNC1((void))
            		...
            		void _hx_run( ::Dynamic _){
            			HX_GC_STACKFRAME(&_hx_pos_7b9d652bf7289928_256_initSongsManifest)
HXLINE( 256)			promise->error(((HX_("There is no asset library with an ID of \"",8b,06,e2,9a) + id) + HX_("\"",22,00,00,00)));
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_7b9d652bf7289928_197_initSongsManifest)
HXLINE( 198)		::String id = HX_("songs",fe,36,c7,80);
HXLINE( 199)		 ::lime::app::Promise_lime_utils_AssetLibrary promise =  ::lime::app::Promise_lime_utils_AssetLibrary_obj::__alloc( HX_CTX );
HXLINE( 201)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::getLibrary(id);
HXLINE( 203)		if (::hx::IsNotNull( library )) {
HXLINE( 205)			return ::lime::app::Future_obj::withValue(library);
            		}
HXLINE( 208)		::String path = id;
HXLINE( 209)		::String rootPath = null();
HXLINE( 212)		 ::haxe::ds::StringMap libraryPaths = ::lime::utils::Assets_obj::libraryPaths;
HXLINE( 213)		if (libraryPaths->exists(id)) {
HXLINE( 215)			path = libraryPaths->get_string(id);
HXLINE( 216)			rootPath = ::haxe::io::Path_obj::directory(path);
            		}
            		else {
HXLINE( 220)			if (::StringTools_obj::endsWith(path,HX_(".bundle",30,4a,b8,4e))) {
HXLINE( 222)				rootPath = path;
HXLINE( 223)				path = (path + HX_("/library.json",2a,a7,07,47));
            			}
            			else {
HXLINE( 227)				rootPath = ::haxe::io::Path_obj::directory(path);
            			}
HXLINE( 230)			path = ::lime::utils::Assets_obj::_hx___cacheBreak(path);
            		}
HXLINE( 233)		::lime::utils::AssetManifest_obj::loadFromFile(path,rootPath)->onComplete( ::Dynamic(new _hx_Closure_0(id,promise)))->onError( ::Dynamic(new _hx_Closure_1(id,promise)));
HXLINE( 259)		return promise->future;
            	}
