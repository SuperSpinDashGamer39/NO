...
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_217_update,"Note","update",0xca3a1ee5,"Note.update","Note.hx",217,0x1a8855ec)
...
void Note_obj::__construct(Float strumTime,int noteData, ::Note prevNote, ::Dynamic __o_sustainNote, ::Dynamic __o_noteType, ::Dynamic __o_inCharter){
...
HXLINE(  39)		this->rating = HX_("shit",c0,cf,52,4c);
HXLINE(  31)		this->noteScore = ((Float)1);
...
HXLINE(  56)		if ((this->strumTime < 0)) {
HXLINE(  57)			this->strumTime = ( (Float)(0) );
            		}
HXLINE(  59)		this->noteData = noteData;
HXLINE(  61)		::String daStage = ::PlayState_obj::curStage;
HXLINE(  63)		if (::hx::IsEq( ::PlayState_obj::SONG->__Field(HX_("noteStyle",df,ef,aa,c1),::hx::paccDynamic),HX_("pixel",86,c6,a3,c2) )) {
HXLINE(  66)			this->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/arrows-pixels",b7,c3,c7,09)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("week6",c2,95,be,c7)),true,17,17,null(),null());
HXLINE(  68)			this->animation->add(HX_("greenScroll",30,4f,fe,9e),::Array_obj< int >::fromData( _hx_array_data_33e34412_1,1),null(),null(),null(),null());
HXLINE(  69)			this->animation->add(HX_("redScroll",3e,78,c3,3a),::Array_obj< int >::fromData( _hx_array_data_33e34412_2,1),null(),null(),null(),null());
HXLINE(  70)			this->animation->add(HX_("blueScroll",47,7e,59,a2),::Array_obj< int >::fromData( _hx_array_data_33e34412_3,1),null(),null(),null(),null());
HXLINE(  71)			this->animation->add(HX_("purpleScroll",69,97,67,99),::Array_obj< int >::fromData( _hx_array_data_33e34412_4,1),null(),null(),null(),null());
HXLINE(  73)			if (this->isSustainNote) {
HXLINE(  75)				this->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/arrowEnds",08,21,6c,fd)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("week6",c2,95,be,c7)),true,7,6,null(),null());
HXLINE(  77)				this->animation->add(HX_("purpleholdend",40,d5,15,5b),::Array_obj< int >::fromData( _hx_array_data_33e34412_5,1),null(),null(),null(),null());
HXLINE(  78)				this->animation->add(HX_("greenholdend",99,eb,5f,39),::Array_obj< int >::fromData( _hx_array_data_33e34412_6,1),null(),null(),null(),null());
HXLINE(  79)				this->animation->add(HX_("redholdend",cb,ae,1e,ea),::Array_obj< int >::fromData( _hx_array_data_33e34412_7,1),null(),null(),null(),null());
HXLINE(  80)				this->animation->add(HX_("blueholdend",a2,f0,cd,25),::Array_obj< int >::fromData( _hx_array_data_33e34412_8,1),null(),null(),null(),null());
HXLINE(  82)				this->animation->add(HX_("purplehold",7b,8d,da,cd),::Array_obj< int >::fromData( _hx_array_data_33e34412_9,1),null(),null(),null(),null());
HXLINE(  83)				this->animation->add(HX_("greenhold",82,f5,c1,bc),::Array_obj< int >::fromData( _hx_array_data_33e34412_10,1),null(),null(),null(),null());
HXLINE(  84)				this->animation->add(HX_("redhold",10,1f,bf,bf),::Array_obj< int >::fromData( _hx_array_data_33e34412_11,1),null(),null(),null(),null());
HXLINE(  85)				this->animation->add(HX_("bluehold",d9,60,aa,a4),::Array_obj< int >::fromData( _hx_array_data_33e34412_12,1),null(),null(),null(),null());
            			}
HXLINE(  88)			Float _hx_tmp = this->get_width();
HXDLIN(  88)			this->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * ::PlayState_obj::daPixelZoom)),null());
HXLINE(  89)			this->updateHitbox();
            		}
            		else {
HXLINE(  91)			::String library = null();
HXDLIN(  91)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("NOTE_assets",70,3c,09,f7)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN(  91)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("NOTE_assets",70,3c,09,f7)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
...
HXLINE(  98)			this->animation->addByPrefix(HX_("purpleholdend",40,d5,15,5b),HX_("pruple end hold",6e,7c,17,3a),null(),null(),null(),null());
HXLINE(  99)			this->animation->addByPrefix(HX_("greenholdend",99,eb,5f,39),HX_("green hold end",77,4d,45,46),null(),null(),null(),null());
HXLINE( 100)			this->animation->addByPrefix(HX_("redholdend",cb,ae,1e,ea),HX_("red hold end",29,c1,a0,b6),null(),null(),null(),null());
HXLINE( 101)			this->animation->addByPrefix(HX_("blueholdend",a2,f0,cd,25),HX_("blue hold end",c0,66,05,ae),null(),null(),null(),null());
HXLINE( 103)			this->animation->addByPrefix(HX_("purplehold",7b,8d,da,cd),HX_("purple hold piece",b1,8b,b1,d3),null(),null(),null(),null());
HXLINE( 104)			this->animation->addByPrefix(HX_("greenhold",82,f5,c1,bc),HX_("green hold piece",8a,42,68,ae),null(),null(),null(),null());
HXLINE( 105)			this->animation->addByPrefix(HX_("redhold",10,1f,bf,bf),HX_("red hold piece",bc,86,4d,83),null(),null(),null(),null());
HXLINE( 106)			this->animation->addByPrefix(HX_("bluehold",d9,60,aa,a4),HX_("blue hold piece",13,00,58,99),null(),null(),null(),null());
HXLINE( 108)			this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ((Float)0.7))),null());
HXLINE( 109)			this->updateHitbox();
HXLINE( 110)			this->set_antialiasing(true);
HXLINE( 111)			if (::hx::IsEq( noteType,2 )) {
HXLINE( 113)				::String library = null();
HXDLIN( 113)				::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Bomb Notes",03,54,f5,4d)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 113)				this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Bomb Notes",03,54,f5,4d)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 114)				this->animation->addByPrefix(HX_("blueScroll",47,7e,59,a2),HX_("Bomb Note Down0",be,1b,a6,68),null(),null(),null(),null());
HXLINE( 115)				this->animation->addByPrefix(HX_("redScroll",3e,78,c3,3a),HX_("Bomb Note Right0",a4,00,b2,42),null(),null(),null(),null());
HXLINE( 116)				this->animation->addByPrefix(HX_("greenScroll",30,4f,fe,9e),HX_("Bomb Note Up0",a5,fb,76,6a),null(),null(),null(),null());
HXLINE( 117)				this->animation->addByPrefix(HX_("purpleScroll",69,97,67,99),HX_("BombNote Left0",9d,3c,ed,f3),null(),null(),null(),null());
HXLINE( 118)				this->updateHitbox();
HXLINE( 119)				this->set_antialiasing(true);
            			}
HXLINE( 121)			if (::hx::IsEq( noteType,3 )) {
HXLINE( 123)				::String library = null();
HXDLIN( 123)				::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Ballistic_Notes",47,b2,f1,e1)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 123)				this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Ballistic_Notes",47,b2,f1,e1)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 124)				this->animation->addByPrefix(HX_("blueScroll",47,7e,59,a2),HX_("Ballistic Note Down",95,60,d7,73),null(),null(),null(),null());
HXLINE( 125)				this->animation->addByPrefix(HX_("redScroll",3e,78,c3,3a),HX_("Ballistic Note Right",49,d0,35,f4),null(),null(),null(),null());
HXLINE( 126)				this->animation->addByPrefix(HX_("greenScroll",30,4f,fe,9e),HX_("Ballistic Note Up",ce,4b,cf,73),null(),null(),null(),null());
HXLINE( 127)				this->animation->addByPrefix(HX_("purpleScroll",69,97,67,99),HX_("Ballistic Note Left",3a,70,19,79),null(),null(),null(),null());
HXLINE( 128)				this->updateHitbox();
HXLINE( 129)				this->set_antialiasing(true);
            			}
            		}
HXLINE( 134)		switch((int)(noteData)){
            			case (int)0: {
HXLINE( 137)				{
HXLINE( 137)					 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 137)					_g->set_x((_g->x + (::Note_obj::swagWidth * ( (Float)(0) ))));
            				}
HXLINE( 138)				this->animation->play(HX_("purpleScroll",69,97,67,99),null(),null(),null());
            			}
            			break;
            			case (int)1: {
HXLINE( 140)				{
HXLINE( 140)					 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 140)					_g->set_x((_g->x + ::Note_obj::swagWidth));
            				}
HXLINE( 141)				this->animation->play(HX_("blueScroll",47,7e,59,a2),null(),null(),null());
            			}
            			break;
            			case (int)2: {
HXLINE( 143)				{
HXLINE( 143)					 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 143)					_g->set_x((_g->x + (::Note_obj::swagWidth * ( (Float)(2) ))));
            				}
HXLINE( 144)				this->animation->play(HX_("greenScroll",30,4f,fe,9e),null(),null(),null());
            			}
            			break;
            			case (int)3: {
HXLINE( 146)				{
HXLINE( 146)					 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 146)					_g->set_x((_g->x + (::Note_obj::swagWidth * ( (Float)(3) ))));
            				}
HXLINE( 147)				this->animation->play(HX_("redScroll",3e,78,c3,3a),null(),null(),null());
            			}
            			break;
            		}
HXLINE( 159)		bool _hx_tmp;
HXDLIN( 159)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("downscroll",ef,45,d4,4f),::hx::paccDynamic)) )) {
HXLINE( 159)			_hx_tmp = ( (bool)(sustainNote) );
            		}
            		else {
HXLINE( 159)			_hx_tmp = false;
            		}
HXDLIN( 159)		if (_hx_tmp) {
HXLINE( 160)			this->set_flipY(true);
            		}
...
HXLINE( 165)			this->set_alpha(((Float)0.6));
HXLINE( 167)			{
HXLINE( 167)				 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 167)				Float _g1 = _g->x;
HXDLIN( 167)				_g->set_x((_g1 + (this->get_width() / ( (Float)(2) ))));
            			}
HXLINE( 169)			switch((int)(noteData)){
            				case (int)0: {
HXLINE( 178)					this->animation->play(HX_("purpleholdend",40,d5,15,5b),null(),null(),null());
            				}
            				break;
            				case (int)1: {
HXLINE( 176)					this->animation->play(HX_("blueholdend",a2,f0,cd,25),null(),null(),null());
            				...
            				break;
            				case (int)2: {
HXLINE( 172)					this->animation->play(HX_("greenholdend",99,eb,5f,39),null(),null(),null());
            				}
            				break;
            				case (int)3: {
HXLINE( 174)					this->animation->play(HX_("redholdend",cb,ae,1e,ea),null(),null(),null());
            				}
            				break;
            			}
HXLINE( 181)			this->updateHitbox();
HXLINE( 183)			{
HXLINE( 183)				 ::Note _g2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 183)				Float _g3 = _g2->x;
HXDLIN( 183)				_g2->set_x((_g3 - (this->get_width() / ( (Float)(2) ))));
            			}
HXLINE( 185)			if (::StringTools_obj::startsWith(::PlayState_obj::curStage,HX_("school",74,b8,c8,40))) {
HXLINE( 186)				 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 186)				_g->set_x((_g->x + 30));
            			}
HXLINE( 188)			if (prevNote->isSustainNote) {
HXLINE( 190)				switch((int)(prevNote->noteData)){
            					case (int)0: {
HXLINE( 193)						prevNote->animation->play(HX_("purplehold",7b,8d,da,cd),null(),null(),null());
            					}
            					break;
            					case (int)1: {
HXLINE( 195)						prevNote->animation->play(HX_("bluehold",d9,60,aa,a4),null(),null(),null());
            					}
            					break;
            					case (int)2: {
HXLINE( 197)						prevNote->animation->play(HX_("greenhold",82,f5,c1,bc),null(),null(),null());
            					}
            					break;
            					case (int)3: {
HXLINE( 199)						prevNote->animation->play(HX_("redhold",10,1f,bf,bf),null(),null(),null());
            					}
            					break;
            				}
HXLINE( 203)				if (::hx::IsNotEq( ::flixel::FlxG_obj::save->data->__Field(HX_("scrollSpeed",3a,e0,46,cb),::hx::paccDynamic),1 )) {
HXLINE( 204)					 ::flixel::math::FlxPoint _g = prevNote->scale;
HXDLIN( 204)					_g->set_y((_g->y * (((::Conductor_obj::stepCrochet / ( (Float)(100) )) * ((Float)1.5)) * ( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("scrollSpeed",3a,e0,46,cb),::hx::paccDynamic)) ))));
            				}
            				else {
HXLINE( 206)					 ::flixel::math::FlxPoint _g = prevNote->scale;
HXDLIN( 206)					_g->set_y((_g->y * (((::Conductor_obj::stepCrochet / ( (Float)(100) )) * ((Float)1.5)) * ( (Float)(::PlayState_obj::SONG->__Field(HX_("speed",87,97,69,81),::hx::paccDynamic)) ))));
            				}
HXLINE( 207)				prevNote->updateHitbox();
            			}
HXLINE( 211)			bool _hx_tmp;
HXDLIN( 211)			if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("downscroll",ef,45,d4,4f),::hx::paccDynamic)) )) {
HXLINE( 211)				_hx_tmp = this->isSustainNote;
            			}
            			else {
HXLINE( 211)				_hx_tmp = false;
            			}
HXDLIN( 211)			if (_hx_tmp) {
HXLINE( 212)				this->set_flipY(true);
            			}
            		}
            	}
...
void Note_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_217_update)
HXLINE( 218)		this->super::update(elapsed);
HXLINE( 220)		if (this->mustPress) {
HXLINE( 223)			bool _hx_tmp;
HXDLIN( 223)			if ((this->strumTime > (::Conductor_obj::songPosition - (::Conductor_obj::safeZoneOffset * ((Float)1.5))))) {
HXLINE( 223)				_hx_tmp = (this->strumTime < (::Conductor_obj::songPosition + (::Conductor_obj::safeZoneOffset * ((Float)0.5))));
            			}
            			else {
HXLINE( 223)				_hx_tmp = false;
            			}
HXDLIN( 223)			if (_hx_tmp) {
HXLINE( 225)				this->canBeHit = true;
            			}
            			else {
HXLINE( 227)				this->canBeHit = false;
            			}
HXLINE( 229)			bool _hx_tmp1;
HXDLIN( 229)			if ((this->strumTime < (::Conductor_obj::songPosition - (::Conductor_obj::safeZoneOffset * ::Conductor_obj::timeScale)))) {
HXLINE( 229)				_hx_tmp1 = !(this->wasGoodHit);
            			}
            			else {
HXLINE( 229)				_hx_tmp1 = false;
            			}
HXDLIN( 229)			if (_hx_tmp1) {
HXLINE( 230)				this->tooLate = true;
            			}
HXLINE( 232)			bool _hx_tmp2;
HXDLIN( 232)			bool _hx_tmp3;
HXDLIN( 232)			if ((this->strumTime > ((::Conductor_obj::songPosition + (::Conductor_obj::safeZoneOffset / ( (Float)(2) ))) - ( (Float)(30) )))) {
HXLINE( 232)				_hx_tmp3 = !(this->canBeHit);
            			}
            			else {
HXLINE( 232)				_hx_tmp3 = false;
            			}
HXDLIN( 232)			if (_hx_tmp3) {
HXLINE( 232)				_hx_tmp2 = !(this->tooEarly);
            			}
            			else {
HXLINE( 232)				_hx_tmp2 = false;
            			}
HXDLIN( 232)			if (_hx_tmp2) {
HXLINE( 233)				this->tooEarly = true;
            			}
            			else {
HXLINE( 235)				this->tooEarly = false;
            			}
            		}
            		else {
HXLINE( 239)			this->canBeHit = false;
HXLINE( 241)			if ((this->strumTime <= ::Conductor_obj::songPosition)) {
HXLINE( 242)				this->wasGoodHit = true;
            			}
            		}
HXLINE( 245)		if (this->tooLate) {
HXLINE( 247)			if ((this->alpha > ((Float)0.3))) {
HXLINE( 248)				this->set_alpha(((Float)0.3));
            			}
            		}
            	}
...
::hx::ObjectPtr< Note_obj > Note_obj::__new(Float strumTime,int noteData, ::Note prevNote, ::Dynamic __o_sustainNote, ::Dynamic __o_noteType, ::Dynamic __o_inCharter) {
	::hx::ObjectPtr< Note_obj > __this = new Note_obj();
	__this->__construct(strumTime,noteData,prevNote,__o_sustainNote,__o_noteType,__o_inCharter);
	return __this;
}

::hx::ObjectPtr< Note_obj > Note_obj::__alloc(::hx::Ctx *_hx_ctx,Float strumTime,int noteData, ::Note prevNote, ::Dynamic __o_sustainNote, ::Dynamic __o_noteType, ::Dynamic __o_inCharter) {
...
void Note_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(tooEarly,"tooEarly");
...
void Note_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(tooEarly,"tooEarly");
...
::hx::Val Note_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"tooEarly") ) { return ::hx::Val( tooEarly ); }
...
::hx::Val Note_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"tooEarly") ) { tooEarly=inValue.Cast< bool >(); return inValue; }
...
void Note_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("tooEarly",6f,d9,61,4f));
...
static ::hx::StorageInfo Note_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsBool,(int)offsetof(Note_obj,tooEarly),HX_("tooEarly",6f,d9,61,4f)},
