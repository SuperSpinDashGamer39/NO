...
HX_DEFINE_STACK_FRAME(_hx_pos_da44038d8b33767f_290_new,"FPSOption","new",0xd6c03010,"FPSOption.new","Options.hx",290,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_da44038d8b33767f_296_press,"FPSOption","press",0x5a8fff33,"FPSOption.press","Options.hx",296,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_da44038d8b33767f_305_updateDisplay,"FPSOption","updateDisplay",0x3edb6ae9,"FPSOption.updateDisplay","Options.hx",305,0x9d9a0240)

void FPSOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_da44038d8b33767f_290_new)
...
bool FPSOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_da44038d8b33767f_296_press)
HXLINE( 297)		::flixel::FlxG_obj::save->data->__SetField(HX_("fps",e9,c7,4d,00),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 298)		::hx::TCast<  ::Main >::cast(::openfl::Lib_obj::get_current()->getChildAt(0))->toggleFPS(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) ));
HXLINE( 299)		this->display = this->updateDisplay();
HXLINE( 300)		return true;
            	}


::String FPSOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_da44038d8b33767f_305_updateDisplay)
HXDLIN( 305)		::String _hx_tmp;
HXDLIN( 305)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) ))) {
HXDLIN( 305)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 305)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 305)		return (HX_("FPS Counter ",fb,a4,fc,60) + _hx_tmp);
            	}
