...
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_42_numberArray,"CoolUtil","numberArray",0x9e0008ad,"CoolUtil.numberArray","CoolUtil.hx",42,0x9f143813)
...
::Array< int > CoolUtil_obj::numberArray(int max, ::Dynamic __o_min){
            	...
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_42_numberArray)
HXLINE(  43)		::Array< int > dumbArray = ::Array_obj< int >::__new(0);
HXLINE(  44)		{
HXLINE(  44)			int _g = ( (int)(min) );
HXDLIN(  44)			int _g1 = max;
HXDLIN(  44)			while((_g < _g1)){
HXLINE(  44)				_g = (_g + 1);
HXDLIN(  44)				int i = (_g - 1);
HXLINE(  46)				dumbArray->push(i);
            			}
            		}
HXLINE(  48)		return dumbArray;
            	}
