...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_292_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",292,0x0d86f62d)
...
HXLINE( 296)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 295)		this->week = 0;
HXLINE( 294)		this->songName = HX_("",00,00,00,00);
HXLINE( 300)		this->songName = song;
HXLINE( 301)		this->week = week;
HXLINE( 302)		this->songCharacter = songCharacter;
            	}
