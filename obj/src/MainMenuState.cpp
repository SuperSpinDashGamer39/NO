...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_227_changeItem,"MainMenuState","changeItem",0xf62bd498,"MainMenuState.changeItem","MainMenuState.hx",227,0x0e5db805)
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_218_changeItem,"MainMenuState","changeItem",0xf62bd498,"MainMenuState.changeItem","MainMenuState.hx",218,0x0e5db805)
...
HXLINE( 106)			versionShit = ((HX_(" FNF - ",55,b8,48,47) + ::MainMenuState_obj::kadeEngineVer) + HX_(" Kade Engine ",b5,9f,9a,10));
            		}
            		else {
HXLINE( 106)			versionShit = HX_(" ",20,00,00,00);
            		}
HXDLIN( 106)		::String versionShit1;
HXDLIN( 106)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("hardBeaten",aa,28,0f,8e),::hx::paccDynamic) )) {
HXLINE( 106)			if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("hardBeaten",aa,28,0f,8e),::hx::paccDynamic)) )) {
HXLINE( 106)				versionShit1 = HX_("You have beaten The Bonus Week on Hard!",e7,67,0f,c7);
            			}
            			else {
HXLINE( 106)				versionShit1 = HX_("",00,00,00,00);
            			}
            		}
            		else {
HXLINE( 106)			versionShit1 = HX_("",00,00,00,00);
            		}
HXDLIN( 106)		 ::flixel::text::FlxText versionShit2 =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,5,(::flixel::FlxG_obj::height - 18),0,((::MainMenuState_obj::gameVer + versionShit) + versionShit1),12,null());
HXLINE( 107)		versionShit2->scrollFactor->set(null(),null());
HXLINE( 108)		versionShit2->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 109)		this->add(versionShit2);
...
HXLINE( 213)			spr->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
            		}
...
HXLINE( 187)								::String daChoice = _gthis->optionShit->__get(_gthis->curSelected);
HXLINE( 189)								::String _hx_switch_0 = daChoice;
            								if (  (_hx_switch_0==HX_("freeplay",a0,90,86,22)) ){
HXLINE( 195)									{
HXLINE( 195)										 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 195)										if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 195)											::flixel::FlxG_obj::game->_requestedState = nextState;
            										}
            									}
HXLINE( 197)									::haxe::Log_obj::trace(HX_("Freeplay Menu Selected",9c,6d,5a,ca),::hx::SourceInfo(HX_("source/MainMenuState.hx",f9,ee,86,cf),197,HX_("MainMenuState",59,88,5e,20),HX_("update",09,86,05,87)));
HXLINE( 194)									goto _hx_goto_4;
            								}
            								if (  (_hx_switch_0==HX_("options",5e,33,fe,df)) ){
HXLINE( 200)									 ::flixel::FlxState nextState =  ::OptionsMenu_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 200)									if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 200)										::flixel::FlxG_obj::game->_requestedState = nextState;
            									}
HXDLIN( 200)									goto _hx_goto_4;
            								}
            								if (  (_hx_switch_0==HX_("story mode",6e,d7,a7,5e)) ){
HXLINE( 192)									{
HXLINE( 192)										 ::flixel::FlxState nextState =  ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 192)										if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 192)											::flixel::FlxG_obj::game->_requestedState = nextState;
            										}
            									}
HXLINE( 193)									::haxe::Log_obj::trace(HX_("Story Menu Selected",71,ff,9b,4a),::hx::SourceInfo(HX_("source/MainMenuState.hx",f9,ee,86,cf),193,HX_("MainMenuState",59,88,5e,20),HX_("update",09,86,05,87)));
...
HXLINE( 185)							::flixel::effects::FlxFlicker_obj::flicker(spr,1,((Float)0.06),false,false, ::Dynamic(new _hx_Closure_1(_gthis)),null());
            						}
            					}
            					HX_END_LOCAL_FUNC1((void))
...
HXLINE( 167)					if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) )) {
HXLINE( 168)						::flixel::effects::FlxFlicker_obj::flicker(this->magenta,((Float)1.1),((Float)0.15),false,null(),null(),null());
            					}
HXLINE( 171)					this->menuItems->forEach( ::Dynamic(new _hx_Closure_2(_gthis)),null());
            				}
            			}
            		}
HXLINE( 209)		this->super::update(elapsed);
HXLINE( 211)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_3()),null());
            	}
...
void MainMenuState_obj::changeItem(::hx::Null< int >  __o_huh){
            		...
            		void _hx_run( ::flixel::FlxSprite spr){
            			HX_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_227_changeItem)
HXLINE( 228)			spr->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 230)			if ((spr->ID == _gthis->curSelected)) {
HXLINE( 232)				spr->animation->play(HX_("selected",5b,2a,6d,b1),null(),null(),null());
HXLINE( 233)				 ::flixel::FlxObject _gthis1 = _gthis->camFollow;
HXDLIN( 233)				Float _hx_tmp = spr->getGraphicMidpoint(null())->x;
HXDLIN( 233)				_gthis1->setPosition(_hx_tmp,spr->getGraphicMidpoint(null())->y);
            			}
HXLINE( 236)			spr->updateHitbox();
            		}
            		HX_END_LOCAL_FUNC1((void))

            		int huh = __o_huh.Default(0);
            	HX_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_218_changeItem)
HXLINE( 217)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 219)		 ::MainMenuState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 219)		_hx_tmp->curSelected = (_hx_tmp->curSelected + huh);
HXLINE( 221)		if ((this->curSelected >= this->menuItems->length)) {
HXLINE( 222)			this->curSelected = 0;
            		}
HXLINE( 223)		if ((this->curSelected < 0)) {
HXLINE( 224)			this->curSelected = (this->menuItems->length - 1);
            		}
HXLINE( 226)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_0(_gthis)),null());
            	}
