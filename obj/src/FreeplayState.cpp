...
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_216_changeDiff,"FreeplayState","changeDiff",0x302511b2,"FreeplayState.changeDiff","FreeplayState.hx",216,0x0d86f62d)
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_240_changeSelection,"FreeplayState","changeSelection",0xbe8c8f7f,"FreeplayState.changeSelection","FreeplayState.hx",240,0x0d86f62d)
...
HXLINE( 169)		Float a = ( (Float)(this->lerpScore) );
HXDLIN( 169)		this->lerpScore = ::Math_obj::floor((a + (((Float)0.4) * (( (Float)(this->intendedScore) ) - a))));
HXLINE( 171)		if ((::Math_obj::abs(( (Float)((this->lerpScore - this->intendedScore)) )) <= 10)) {
HXLINE( 172)			this->lerpScore = this->intendedScore;
            		}
HXLINE( 174)		this->scoreText->set_text((HX_("PERSONAL BEST:",36,ce,e9,ee) + this->lerpScore));
HXLINE( 176)		bool upP = ::PlayerSettings_obj::player1->controls->_upP->check();
HXLINE( 177)		bool downP = ::PlayerSettings_obj::player1->controls->_downP->check();
HXLINE( 178)		bool accepted = ::PlayerSettings_obj::player1->controls->_accept->check();
HXLINE( 180)		if (upP) {
...
HXLINE( 189)		if (::PlayerSettings_obj::player1->controls->_leftP->check()) {
HXLINE( 190)			this->changeDiff(-1);
            		}
HXLINE( 191)		if (::PlayerSettings_obj::player1->controls->_rightP->check()) {
HXLINE( 192)			this->changeDiff(1);
            		}
HXLINE( 194)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE( 196)			 ::flixel::FlxState nextState =  ::MainMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 196)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 196)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
HXLINE( 199)		if (accepted) {
HXLINE( 201)			::String poop = this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName.toLowerCase();
HXDLIN( 201)			::String poop1 = ::Highscore_obj::formatSong(poop,this->curDifficulty);
HXLINE( 203)			::haxe::Log_obj::trace(poop1,::hx::SourceInfo(HX_("source/FreeplayState.hx",21,2d,b0,ce),203,HX_("FreeplayState",31,61,f2,b3),HX_("update",09,86,05,87)));
HXLINE( 205)			::PlayState_obj::SONG = ::Song_obj::loadFromJson(poop1,this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName.toLowerCase());
HXLINE( 206)			::PlayState_obj::isStoryMode = false;
HXLINE( 207)			::PlayState_obj::storyDifficulty = this->curDifficulty;
HXLINE( 208)			::PlayState_obj::loadRep = false;
HXLINE( 209)			::PlayState_obj::storyWeek = this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->week;
HXLINE( 210)			::haxe::Log_obj::trace((HX_("CUR WEEK",b4,9a,a0,36) + ::PlayState_obj::storyWeek),::hx::SourceInfo(HX_("source/FreeplayState.hx",21,2d,b0,ce),210,HX_("FreeplayState",31,61,f2,b3),HX_("update",09,86,05,87)));
HXLINE( 211)			{
HXLINE( 211)				 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
...
void FreeplayState_obj::changeDiff(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_86166a84e8de7ace_216_changeDiff)
HXLINE( 217)		 ::FreeplayState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 217)		_hx_tmp->curDifficulty = (_hx_tmp->curDifficulty + change);
HXLINE( 219)		if ((this->curDifficulty < 0)) {
HXLINE( 220)			this->curDifficulty = 2;
            		}
HXLINE( 221)		if ((this->curDifficulty > 2)) {
HXLINE( 222)			this->curDifficulty = 0;
            		}
HXLINE( 225)		this->intendedScore = ::Highscore_obj::getScore(this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName,this->curDifficulty);
HXLINE( 228)		switch((int)(this->curDifficulty)){
            			case (int)0: {
HXLINE( 231)				this->diffText->set_text(HX_("EASY",02,54,cd,2d));
            			}
            			break;
            			case (int)1: {
HXLINE( 233)				this->diffText->set_text(HX_("NORMAL",27,1e,ec,e2));
            			}
            			break;
            			case (int)2: {
HXLINE( 235)				this->diffText->set_text(HX_("HARD",eb,f6,c8,2f));
            			}
            			break;
            		}
            	}
...
void FreeplayState_obj::changeSelection(::hx::Null< int >  __o_change){
            		int change = __o_change.Default(0);
            	HX_STACKFRAME(&_hx_pos_86166a84e8de7ace_240_changeSelection)
...
HXLINE( 248)		 ::FreeplayState _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 248)		_hx_tmp1->curSelected = (_hx_tmp1->curSelected + change);
HXLINE( 250)		if ((this->curSelected < 0)) {
HXLINE( 251)			this->curSelected = (this->songs->length - 1);
            		}
HXLINE( 252)		if ((this->curSelected >= this->songs->length)) {
HXLINE( 253)			this->curSelected = 0;
            		}
HXLINE( 258)		this->intendedScore = ::Highscore_obj::getScore(this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName,this->curDifficulty);
HXLINE( 263)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp2 = ::flixel::FlxG_obj::sound;
HXDLIN( 263)		_hx_tmp2->playMusic((((HX_("songs:assets/songs/",c1,ed,e6,7e) + this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName.toLowerCase()) + HX_("/Inst.",f9,6e,13,1c)) + HX_("ogg",4f,94,54,00)),0,null(),null());
HXLINE( 266)		int bullShit = 0;
HXLINE( 268)		{
HXLINE( 268)			int _g = 0;
HXDLIN( 268)			int _g1 = this->iconArray->length;
HXDLIN( 268)			while((_g < _g1)){
HXLINE( 268)				_g = (_g + 1);
HXDLIN( 268)				int i = (_g - 1);
HXLINE( 270)				this->iconArray->__get(i).StaticCast<  ::HealthIcon >()->set_alpha(((Float)0.6));
            			}
            		}
HXLINE( 273)		this->iconArray->__get(this->curSelected).StaticCast<  ::HealthIcon >()->set_alpha(( (Float)(1) ));
HXLINE( 275)		{
HXLINE( 275)			int _g2 = 0;
HXDLIN( 275)			::Array< ::Dynamic> _g3 = this->grpSongs->members;
HXDLIN( 275)			while((_g2 < _g3->length)){
HXLINE( 275)				 ::Alphabet item = _g3->__get(_g2).StaticCast<  ::Alphabet >();
HXDLIN( 275)				_g2 = (_g2 + 1);
HXLINE( 277)				item->targetY = ( (Float)((bullShit - this->curSelected)) );
HXLINE( 278)				bullShit = (bullShit + 1);
HXLINE( 280)				item->set_alpha(((Float)0.6));
HXLINE( 283)				if ((item->targetY == 0)) {
HXLINE( 285)					item->set_alpha(( (Float)(1) ));
            				}
            			}
            		}
            	}
